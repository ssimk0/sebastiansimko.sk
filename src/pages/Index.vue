<template>
  <Layout>
    ...
    <div class="lg:p-20 md:p-10 p-5">
      <p class="text-3xl lg:pl-20 font-light md:pl-10 pl-5">
        I'm experienced full-stack web developer.
      </p>
      <div class="flex pt-10">
        <div class="flex-1 lg:pl-20 leading-loose md:pl-10 pl-5">
        ...
        <div class="flex-1 text-right lg:pr-20 leading-loose md:pr-10 pr-5">
          ...
          <ul class="text-sm">
            ...
            <li>GO lang in web application</li>
            <li>Docker & Kubernetes</li>
            <li>Python</li>
            <li>Modern PHP</li>
            <li>Automation Processes</li>
          </ul>
        </div>
      </div>
      ...
      <div class="flex pt-10">
        ...
        <div class="flex-1 text-right lg:pr-20 leading-loose md:pr-10 pr-5">
          ...
          <ul class="text-sm">
            ...
            <li>Master the Kubernetes</li>
            <li>Find new ways to apply automation</li>
            <li>Became the architect level of developer</li>
          </ul>
        </div>
      </div>
    </div>
